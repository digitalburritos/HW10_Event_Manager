...
Fixed issues in:
[`user_schemas.py`](https://github.com/digitalburritos/hw10_event_manager/blob/1-nickname-doesnt-match/app/schemas/user_schemas.py#L43-L50) [`user_service.py`](https://github.com/digitalburritos/hw10_event_manager/blob/1-nickname-doesnt-match/app/services/user_service.py#L61-L69) 
